                	...
                	<form role="form" action="../index.php" method="post">
                  		<div class="box-body">
                    		<div class="form-group" id="divSubject">
                      			...
                      			<input type="text" class="form-control" id="name" placeholder="Enter Course name" name="name" autocomplete="off">
                    		</div>
                  		</div><!-- /.box-body -->
...
//MSK-000098-form submit	
	...
	if(name == ''){
		...
		$('#divSubject').append('<span id="spanName" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The Course is required" ></span>');	
...
//MSK-000108
	...
	if(name1 == ''){
		...
		$('#divSubjectUpdate').append('<span id="spanSubjectUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The course is required" ></span>');	
